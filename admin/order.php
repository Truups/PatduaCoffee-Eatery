...
<head>
    ...
    <script src="/statusColor.js"></script>
    <script src="/load_Oto.js"></script>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
            ...
            <form id="formCari" class="mb-4 mt-4">
                <input type="text" id="inputCari" name="inputCari" placeholder="Cari Kode Order / Nama Pelanggan" class="border border-gray-300 rounded px-3 py-2 w-1/2">
